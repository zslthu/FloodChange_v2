%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [bestx,bestf] = sceua(x0,bl,bu,EF_All)
...
%  ngs = number of complexes (sub-populations) (def: ngs=2)
...
while icall<maxn & gnrng>peps & criter_change>pcento;
    ...
    for igs = 1: ngs;
        ...
        for loop=1:nspl;
            ...
            [snew,fnew,icall]=cceua(s,sf,bl,bu,icall,EF_All);
